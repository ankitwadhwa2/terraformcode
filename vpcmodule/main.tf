...
resource "aws_vpc" "main" {
  ...
  enable_dns_hostnames = true  ### It assigns hostname to instance
  enable_dns_support   = true  ### It assigns hostname to instance
...
# Private Route Table  ---- Define DEFAULT ROUTE Table
